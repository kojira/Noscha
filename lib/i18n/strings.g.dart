...
extension AppLocaleExtensions on AppLocale {
	...
	_StringsEn get translations {
		switch (this) {
			...
			case AppLocale.jaJp: return _translationsJaJp;
		}
	}
	...
	_StringsEn build() {
		switch (this) {
			...
			case AppLocale.jaJp: return _StringsJaJp.build();
		}
	}
	...
	String get languageTag {
		switch (this) {
			...
			case AppLocale.jaJp: return 'ja-JP';
		}
	}
	...
	Locale get flutterLocale {
		switch (this) {
			...
			case AppLocale.jaJp: return const Locale.fromSubtags(languageCode: 'ja', countryCode: 'JP');
		}
	}
}
...
extension StringAppLocaleExtensions on String {
	AppLocale? toAppLocale() {
		switch (this) {
			...
			case 'ja-JP': return AppLocale.jaJp;
			default: return null;
		}
	}
}
...
class _StringsJaJp implements _StringsEn {
	...
	// Translations
	@override String get Noscha => 'Noscha';
